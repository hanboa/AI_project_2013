function [recall, precision, rand_values] = test(X, bit, method, Dic)
%
...
num_totalSamples = 30600;% the number for sampling total patches
num_thresholdSamples = 5;% the number of samples to decide a threshold
rand_values = struct();
[X_patches rand_values]= getdata_imagearray(IMAGE_WHITEN_AI, windowSize, num_totalSamples);
X = X_patches';
...
display 'Hamming Distance Start:'
